...
class Customer
{
     ...
     * @Assert\Length(min=3, minMessage="Le nom de famille doit faire entre 3 et 255 caractères !", max=255, maxMessage="Le nom de fzmille doit faire entre 3 et 255 caractères !" )
     */
    private $lastName;
     ...
     * @Assert\Email(message="Le format Email doit être valide")
     */
    private $email;
    ...
    /** 
     * Permet de récupérer total non payé (montant total hors factures payées ou annulées )
     * @Groups({"customers_read"})
    */
